...
// 		if (url.pathname === '/subscription-plan' && request.method === 'POST') {
...
// 		if (url.pathname.startsWith('/subscription-plan/') && request.method === 'GET') {
...
// 		if (url.pathname === '/assign-subscription' && request.method === 'POST') {
// 			const { customerId, planId } = await request.json() as { customerId: string, planId: string };
// 			const updatedCustomer = await subscriptionHandler.assignSubscriptionToCustomer(customerId, planId);
...
// 			const updatedCustomer = await subscriptionHandler.cancelSubscription(customerId);
// 			return new Response(JSON.stringify(updatedCustomer));
// 		}
...
// 		if (url.pathname === '/change-plan' && request.method === 'POST') {
